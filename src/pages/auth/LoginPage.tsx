          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                <input type={showPassword ? "text" : "password"} placeholder="Enter your password" className="h-11 w-full rounded-lg border bg-card px-4 pr-10 text-sm outline-none focus:border-secondary focus:ring-1 focus:ring-secondary" />
            ...
            <Button variant="success" className="w-full h-11">Sign In</Button>
